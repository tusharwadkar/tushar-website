...
import { SplineScene } from "@/components/ui/spline-viewer";
      ...
      <div className="mx-auto max-w-7xl">
        <Card className="w-full min-h-[900px] md:h-[600px] bg-black/[0.96] relative overflow-hidden rounded-[3rem] border-zinc-800">
          ...
          <div className="flex flex-col md:flex-row h-full">
            {/* Left content */}
            <div className="flex-1 p-8 sm:p-12 relative z-20 flex flex-col justify-center text-center md:text-left">
              ...
              <p className="mt-6 text-neutral-400 max-w-lg mx-auto md:mx-0 text-base sm:text-lg leading-relaxed font-medium">
